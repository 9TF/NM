	...
	<section id="main" class="bg-dark">
		...
		<div id="chatbox">
			<div id="data_container" class="">
				...
				<h2>Namaste Messenger</h2>
				<p class="text-center my-2">Just connect your device to local network. <br> And you are reddy to explore<br> The local world.</p>
			</div>
